...
sys.path.append(
    os.path.abspath(
        os.path.join(os.path.dirname(__file__), "../lambda/lambda_list_item")
    )
)
...
class TestListarTarefas(unittest.TestCase):
    ...
    def test_listar_tarefas_com_data_sucesso(self, mock_dynamodb):
        ...
        mock_table.query.return_value = {
            "Items": [self.sample_items[0], self.sample_items[1]]
        }
...
class TestLambdaHandler(unittest.TestCase):
    ...
    def test_lambda_handler_body_parameters(self, mock_listar_tarefas):
        ...
        event = {"body": json.dumps({"data": "2024-12-26", "user_id": "user-123"})}
        context = {}
    ...
    def test_lambda_handler_cognito_user(self, mock_listar_tarefas):
        ...
        # Assert
        self.assertEqual(response["statusCode"], 200)
        mock_listar_tarefas.assert_called_once_with(
            "2024-12-26", "cognito-user-123-456"
        )
...
class TestIntegracao(unittest.TestCase):
    ...
    def test_cenario_usuario_novo_sem_tarefas(self, mock_dynamodb):
        ...
        event = {
            "requestContext": {"authorizer": {"claims": {"sub": "novo-usuario-123"}}}
        }
        context = {}
    ...
    def test_cenario_busca_data_especifica(self, mock_dynamodb):
        ...
        event = {
            "queryStringParameters": {"data": "2024-12-26"},
            "requestContext": {"authorizer": {"claims": {"sub": "usuario-ativo-456"}}},
        }
        context = {}
...
if __name__ == "__main__":
    ...
    print(
        "   python -m pytest test_list_tasks.py::TestListarTarefas::test_listar_tarefas_com_data_sucesso -v"
    )
